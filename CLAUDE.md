...
| Versión actual | `1.42.1` — en `karmcp.php` (cabecera + `KARMCP_VERSION`) y `readme.txt` (`Stable tag`); los tres tienen que coincidir, y `VersionTripleTest` lo comprueba |
...
Estado de referencia (medido el 2026-09-21): **1.549 tests, 10.031 aserciones**; **PHPStan sin errores**; **PHPCS sin errores ni avisos**. Las tres bloquean. Cualquier hallazgo que veas lo ha introducido lo que estés cambiando.
