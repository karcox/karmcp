...
class KarMCP_Security_Hardening_Audit {
	...
	public function run(): array {
		...
		// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedHooknameFound -- WordPress core's filter; asking it is how we learn whether XML-RPC is on.
