...
<div class="elementor-mcp-context">
	<div class="elementor-mcp-section">
		...
		<form method="post" action="options.php" class="elementor-mcp-context-form">
			...
			<p class="elementor-mcp-context-toolbar">
				<button type="button" class="button" id="elementor-mcp-context-template"><?php esc_html_e( 'Insert starter template', 'karmcp' ); ?></button>
	...
	<div class="elementor-mcp-section">
		...
		<pre class="elementor-mcp-context-preview" id="elementor-mcp-context-preview"><?php echo esc_html( $karmcp_ctx_final ); ?></pre>
	</div>
</div>
